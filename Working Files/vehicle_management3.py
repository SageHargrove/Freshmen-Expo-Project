class Vehicle:
    def __init__(self, vehicle_type, road_temperature, wheel_count=4):
        ...
        self.tire_temperature = [80.0] * self.wheel_count  # Default temperature for each tire
        self.wheel_speed = [0.0] * self.wheel_count

    def update_wheel_speed(self, speeds):
            self.wheel_speed[0] += speeds

    def update_temp(self, temp):
        self.tire_temperature[0] = temp

    def update_road_temp(self, temp):
        self.road_temperature = temp
    ...
    def display_status(self):
        ...
        status += f"Wheel Rotations: {self.wheel_speed}"
        return status
